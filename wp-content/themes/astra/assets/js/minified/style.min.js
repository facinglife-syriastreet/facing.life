  ...
  e(),
    (AstraToggleSubMenu = function () {
      ...
      for (
        ...
        a[n].classList.remove("ast-submenu-expanded"),
          (a[n].querySelector(".sub-menu, .children").style.display = "none");
      var s = e.parentNode.querySelectorAll(
        ".menu-item-has-children, .page_item_has_children",
      );
      for (n = 0; n < s.length; n++)
        if (s[n] != e) {
          ...
          for (
            var o = s[n].querySelectorAll(".sub-menu, .children"), r = 0;
            r < o.length;
            r++
          )
      ...
      (e.classList.contains("menu-item-has-children") ||
        e.classList.contains("page_item_has_children")) &&
        (toggleClass(e, "ast-submenu-expanded"),
        e.classList.contains("ast-submenu-expanded")
          ? (e.querySelector(".sub-menu, .children").style.display = "block")
          : (e.querySelector(".sub-menu, .children").style.display = "none"));
    }),
          ...
          if (
            ...
            if (
              ...
              var a = e[t].querySelectorAll(
                ".ast-header-break-point .main-header-menu .menu-item-has-children > a, .ast-header-break-point .main-header-menu .page_item_has_children > a, .ast-header-break-point ul.main-header-menu .ast-menu-toggle",
              );
            else
    ...
    (astraNavMenuToggle = function (e) {
      ...
      for (
        ...
        for (
          var o = n[s].querySelectorAll(".sub-menu, .children"), r = 0;
          r < o.length;
          r++
        )
          o[r].style.display = "none";
      ...
      -1 !==
        ...
        (toggleClass(t[a], "toggle-on"),
        toggleClass(l[a], "toggled"),
  ...
  if (
    ((document.body.onclick = function (e) {
      if (
        ...
        0 === getParents(e.target, ".ast-search-menu-icon").length &&
        0 === getParents(e.target, ".ast-search-icon").length
      )
        for (
